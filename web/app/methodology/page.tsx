...
export default function MethodologyPage() {
  return <main className="route-page">
    <SiteHeader active="methodology" actions={<a className="watch-button route-home-button" href="/">返回概览</a>} />
